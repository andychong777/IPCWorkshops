...
// Todo:
void viewAllAppointments(struct ClinicData* data);//todo

// View appointment schedule for the user input date
// Todo:
void viewAppointmentSchedule(struct ClinicData* data);//todo

// Add an appointment record to the appointment array
// Todo:
void addAppointment(struct Appointment* app, int, struct Patient* pt, int);//todo

// Remove an appointment record from the appointment array
// Todo:
void removeAppointment(struct Appointment* app, int, struct Patient* pt, int);//todo
...
//add function FIX NAMES AND STUFF
